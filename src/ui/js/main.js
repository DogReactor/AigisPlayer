...
const vm = new Vue({
    ...
    methods: {
        ...
        setProxyEnabled: function () {
            ipcRenderer.send('proxyStatusUpdate', {
                enable: this.globalSetting.proxy.enabled,
                isSocks5: this.globalSetting.proxy.socks5,
                host: this.globalSetting.proxy.address,
                port: this.globalSetting.proxy.port
            });
